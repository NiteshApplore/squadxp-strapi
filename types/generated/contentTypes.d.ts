...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    linkedInLink: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bannerAltText: Schema.Attribute.String;
    bannerImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required;
    bannerMobileText: Schema.Attribute.String;
    blogContent: Schema.Attribute.RichText;
    blogSlug: Schema.Attribute.UID<'Title'> & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqs: Schema.Attribute.Component<'blogs-faq.faq', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    seoData: Schema.Attribute.Component<'blogs-faq.seo-data', false> &
      Schema.Attribute.Required;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqs: Schema.Attribute.Component<'blogs-faq.faq', true>;
    frontend: Schema.Attribute.Component<
      'case-study.frontend-container',
      false
    >;
    ...
    > &
      Schema.Attribute.Private;
    metrics: Schema.Attribute.Component<'case-study.metrics-container', true>;
    mobileBannerImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    result: Schema.Attribute.Component<
      'case-study.title-content-container',
      false
    >;
    seoData: Schema.Attribute.Component<'blogs-faq.seo-data', false> &
      Schema.Attribute.Required;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    primaryCode: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEnquiryEnquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    enquirySource: Schema.Attribute.Enumeration<
      ['ContactUs', 'DemoForm', 'Blog', 'CaseStudies', 'LandingPage']
    > &
      Schema.Attribute.Required;
